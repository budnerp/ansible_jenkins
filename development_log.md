...
```
git submodule add https://github.com/budnerp/ansible_role_common.git provisioning/roles/ansible_role_common
git submodule add https://github.com/budnerp/ansible_role_extra_repositories.git provisioning/roles/ansible_role_extra_repositories
git submodule add https://github.com/budnerp/ansible_role_git.git provisioning/roles/ansible_role_git
git submodule add https://github.com/budnerp/ansible_role_java8.git provisioning/roles/ansible_role_java8
git submodule add https://github.com/budnerp/ansible_role_jenkins.git provisioning/roles/ansible_role_jenkins
```
